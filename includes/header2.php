                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        <div class="navbar-header">
                                ...
                                <a href="home.php" class="navbar-brand"><img src="image/logo.png"/></a>
                        </div>
                        <div class="navbar-collapse collapse" id="templatemo-nav-bar" class="external-link">
                            <ul class="nav navbar-nav navbar-right" style="margin-top: 40px;"  role="menu" aria-labelledby="dropdownMenu" aria-expanded="false">
                                ...
                                <li><a href="AttendenceForm.php" class="external-link">AttendanceForm</a></li>
                                  <li><a href="Attendence.php" class="external-link">Attendance</a></li>
