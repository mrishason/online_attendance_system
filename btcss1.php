...
<div class="text-center">
                            <hr class="team_hr team_hr_left hr_gray"/><span class="span_blog txt_darkgrey txt_orange">BTCSS 1 Attendence </span>
...
$select="SELECT * FROM attendance WHERE course='btcss 1'";
